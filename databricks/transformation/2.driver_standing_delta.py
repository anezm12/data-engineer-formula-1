...
# MAGIC %md
# MAGIC
# MAGIC #### Find the race years the dta is to be reprocessed
...
final_df = driver_standing_df.withColumn("rank", rank().over(WindowSpec))
...
# MAGIC
# MAGIC select * 
# MAGIC from f1_presentation.driver_standing